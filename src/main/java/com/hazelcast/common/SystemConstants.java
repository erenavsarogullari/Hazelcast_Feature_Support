...
public class SystemConstants {
	...
	public static final String  ITEM_LISTENER_DEFINITION = "com.hazelcast.annotation.ItemListener";
	public static final String  ENTRY_LISTENER_DEFINITION = "com.hazelcast.annotation.EntryListener";
